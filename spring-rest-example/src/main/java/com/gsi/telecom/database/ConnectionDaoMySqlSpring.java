...
public class ConnectionDaoMySqlSpring {
	/*
	 * Usuario para el acceso a al db 
	 */
	...
	/*
	 * Base de datos de acceso de la aplicación 
	 */
	private String db;
	...
	public Connection getConnection() throws SQLException, ClassNotFoundException {
		...
		// Stablish connection
		Connection con = DriverManager.getConnection( "jdbc:mysql://localhost/" + db, usuario, clave );
		return  con;
	}
	...
	public void printConnection() throws SQLException, ClassNotFoundException {
	    ...
	    */
	    ...
	    while ( rs.next() ) {
	    	...
	    	printTable( con, rs.getString(3) );  // getString(3)==nombre_tabla
