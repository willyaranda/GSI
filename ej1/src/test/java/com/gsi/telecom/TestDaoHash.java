...
public class TestDaoHash extends TestCase {
	...
	/* Tests ProductDaoHash.add function
	 *  In order to test ONLY ProductDaoHast "add" functionality,
	...
	public void testProductDaoHashAdd() {
		...
		HashMap<Integer, Product> hashMapProducts = productDao.getProductsTable();
	...
	/* Tests CustomerDaoHash.add function
	 *  In order to test ONLY CustomerDaoHash "add" functionality,
	 *  the rest of needed functions are executed directly
	 *  from the HashTable
	 * */
	public void testCustomerDaoHashAdd() {
		...
		HashMap<Integer, Customer> hashMapCustomer = customerDao.getCustomersTable();
	...
	/* Tests ProductDaoHash.delete function
	 *  In order to test ONLY ProductDaoHash "delete" functionality,
	 *  the rest of needed functions are executed directly
	 *  from the HashTable
	 * */	
	...
	/* Tests CustomerDaoHash.delete function
	 *  In order to test ONLY CustomerDaoHash "delete" functionality,
	 *  the rest of needed functions are executed directly
	 *  from the HashTable
	 * */	
	...
	/* Tests ProductDaoHash.update function
	 *  In order to test ONLY ProductDaoHash "update" functionality,
	 *  the rest of needed functions are executed directly
	 *  from the HashTable
	 * */
	public void testProductDaoHashUpdate() {
		...
		// Update product
		String randomDescription = Long.toString(Math.abs(random.nextLong()), 10);
	...
	/* Tests CustomerDaoHash.update function
	 *  In order to test ONLY CustomerDaoHash "update" functionality,
	 *  the rest of needed functions are executed directly
	 *  from the HashTable
	 * */
	...
	/* Tests CustomerDaoHash.find function
	 *  In order to test ONLY CustomerDaoHash "find" functionality,
	 *  the rest of needed functions are executed directly
	 *  from the HashTable
	 * */
	...
	/* Tests ProductDaoHash.find function
	 *  In order to test ONLY ProductDaoHash "find" functionality,
	 *  the rest of needed functions are executed directly
	 *  from the HashTable
	 * */
	...
	/* Tests ProductDaoHash.getValidProducts function
	 *  In order to test ONLY ProductDaoHash "getValidProducts" functionality,
	 *  the rest of needed functions are executed directly
	 *  from the HashTable
	 * */
	public void testProductDaoHashGetValidProducts() {
		...
		if(!reference.equals(productValid1) && !reference.equals(productValid2))
			assertFalse(true);
