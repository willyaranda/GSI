...
public class TestDaoMySql extends TestCase {
	...
	/* Generates the String order for insert MySql order in Customer table
	...
	/* Generates the String order for insert MySql order in Product table
	...
	/* Generates the String order for insert MySql order in Customer_Product table
	...
	/* Generates the String order for select MySql order in Customer table
	...
	/* Generates the String order for select MySql order in Product table
	...
	/* Generates the String order for delete MySql order in Customer table
	 * 	with given Customer fields in "where" clause
	...
	/* Generates the String order for delete MySql order in Product table
	 * 	with given Product fields in "where" clause
	 * @id reference id for "where" clause 
	 * @return String order
	 * */
	...
	/* Tests CustomerDaoMySql.add function
	 *  In order to test ONLY CustomerDaoMySql "add" functionality,
	 *  the rest of needed functions are executed directly
	 *  in the database
	 * */
	public void testCustomerDaoMySqlAdd() throws SQLException, ClassNotFoundException {
	...
	/* Tests ProductDaoMySql.add function
	 *  In order to test ONLY ProductDaoMySql "add" functionality,
	 *  the rest of needed functions are executed directly
	 *  in the database
	 * */
	public void testProductDaoMySqlAdd() throws SQLException, ClassNotFoundException {
	...
	/* Tests CustomerDaoMySql.delete function
	 *  In order to test ONLY CustomerDaoMySql "delete" functionality,
	 *  the rest of needed functions are executed directly
	 *  in the database
	 * */
	public void testCustomerDaoMySqlDelete() throws SQLException, ClassNotFoundException {
		// Build reference customer
		Customer customer = buildRandomCustomer();
	...
	/* Tests ProductDaoMySql.delete function
	 *  In order to test ONLY ProductDaoMySql "delete" functionality,
	 *  the rest of needed functions are executed directly
	 *  in the database
	 * */
	public void testProductDaoMySqlDelete() throws SQLException, ClassNotFoundException {
		// Build reference product
		Product product = buildRandomProduct();
	...
	/* Tests CustomerDaoMySql.find function
	 *  In order to test ONLY CustomerDaoMySql "find" functionality,
	 *  the rest of needed functions are executed directly
	 *  in the database
	 * */
	public void testCustomerDaoMySqlFind() throws SQLException, ClassNotFoundException {
		// Build reference customer
		Customer customer = buildRandomCustomer();
	...
	/* Tests ProductDaoMySql.find function
	 *  In order to test ONLY ProductDaoMySql "find" functionality,
	 *  the rest of needed functions are executed directly
	 *  in the database
	 * */
	public void testProductDaoMySqlFind() throws SQLException, ClassNotFoundException {
		// Build reference product
		Product product = buildRandomProduct();
		...
		// Mysql float precission differs from java one: compare just 4 #1 decimals 
	...
	/* Tests CustomerDaoMySql.update function
	 *  In order to test ONLY CustomerDaoMySql "update" functionality,
	 *  the rest of needed functions are executed directly
	 *  in the database
	 * */
	public void testCustomerDaoMySqlUpdate() throws SQLException, ClassNotFoundException {
		// Build reference customer
		Customer customer = buildRandomCustomer();
	...
	/* Tests ProductDaoMySql.update function
	 *  In order to test ONLY ProductDaoMySql "update" functionality,
	 *  the rest of needed functions are executed directly
	 *  in the database
	 * */
	public void testProductDaoMySqlUpdate() throws SQLException, ClassNotFoundException {
		// Build reference product
		Product product = buildRandomProduct();
	...
	/* Tests ProductDaoMySql.getValidProducts function
	 *  In order to test ONLY ProductDaoMySql "getValidProducts" functionality,
	 *  the rest of needed functions are executed directly
	 *  in the database
	 * */
	public void testCustomerDaoMySqlGetProductsForCustomer() throws SQLException, ClassNotFoundException {
	 ...
	 *  in the database
	 * */
	public void testProductDaoMySqlGetValidProducts() throws SQLException, ClassNotFoundException {
		// Build reference product
