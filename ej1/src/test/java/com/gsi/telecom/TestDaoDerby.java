 ...
 *         objects for Customer and Product implemented with Derby
 */
public class TestDaoDerby extends TestCase {
	...
	/*
	 * Generates the String order for insert Derby order in Customer table with
	...
	/*
	 * Generates the String order for insert Derby order in Customer_Product
	...
	/*
	 * Generates the String order for insert Derby order in Product table with
	...
	/*
	 * Generates the String order for delete Derby order in Customer table with
	...
	/*
	 * Generates the String order for delete Derby order in Product table with
	...
	/*
	 * Generates the String order for select Derby order in Customer table with
	 * given Customer fields in "where" clause
	 * 
	...
	/*
	 * Generates the String order for select Derby order in Product table with
	 * given Product fields in "where" clause
	 * 
	...
	/*
	 * Tests CustomerDaoDerby.add function In order to test ONLY
	 * CustomerDaoDerby "add" functionality, the rest of needed functions are
	 * executed directly in the database
	 */
	public void testCustomerDaoDerbyAdd() throws SQLException,
	...
	/*
	 * Tests CustomerDaoDerby.delete function In order to test ONLY
	 * CustomerDaoDerby "delete" functionality, the rest of needed functions are
	 * executed directly in the database
	 */
	public void testCustomerDaoDerbyDelete() throws SQLException,
			ClassNotFoundException {
		// Build reference customer
		Customer customer = buildRandomCustomer();
	...
	/*
	 * Tests CustomerDaoDerby.find function In order to test ONLY
	 * CustomerDaoDerby "find" functionality, the rest of needed functions are
	 * executed directly in the database
	 */
	public void testCustomerDaoDerbyFind() throws SQLException,
			ClassNotFoundException {
		// Build reference customer
		Customer customer = buildRandomCustomer();
	...
	/*
	 * Tests ProductDaoDerby.getValidProducts function In order to test ONLY
	 * ProductDaoDerby "getValidProducts" functionality, the rest of needed
	 * functions are executed directly in the database
	 */
	public void testCustomerDaoDerbyGetProductsForCustomer()
	...
	/*
	 * Tests CustomerDaoDerby.update function In order to test ONLY
	 * CustomerDaoDerby "update" functionality, the rest of needed functions are
	 * executed directly in the database
	 */
	public void testCustomerDaoDerbyUpdate() throws SQLException,
			ClassNotFoundException {
		// Build reference customer
		Customer customer = buildRandomCustomer();
	...
	/*
	 * Tests ProductDaoDerby.add function In order to test ONLY ProductDaoDerby
	 * "add" functionality, the rest of needed functions are executed directly
	 * in the database
	 */
	public void testProductDaoDerbyAdd() throws SQLException,
			ClassNotFoundException {
	...
	/*
	 * Tests ProductDaoDerby.delete function In order to test ONLY
	 * ProductDaoDerby "delete" functionality, the rest of needed functions are
	 * executed directly in the database
	 */
	public void testProductDaoDerbyDelete() throws SQLException,
			ClassNotFoundException {
		// Build reference product
		Product product = buildRandomProduct();
	...
	/*
	 * Tests ProductDaoDerby.find function In order to test ONLY ProductDaoDerby
	 * "find" functionality, the rest of needed functions are executed directly
	 * in the database
	 */
	public void testProductDaoDerbyFind() throws SQLException,
			ClassNotFoundException {
		// Build reference product
		Product product = buildRandomProduct();
		...
		// Derby float precission differs from java one: compare just 4 #1
		// decimals
	 ...
	 * functions are executed directly in the database
	 */
	public void testProductDaoDerbyGetValidProducts() throws SQLException,
			ClassNotFoundException {
		// Build reference product
	...
	/*
	 * Tests ProductDaoDerby.update function In order to test ONLY
	 * ProductDaoDerby "update" functionality, the rest of needed functions are
	 * executed directly in the database
	 */
	public void testProductDaoDerbyUpdate() throws SQLException,
			ClassNotFoundException {
		// Build reference product
		Product product = buildRandomProduct();
